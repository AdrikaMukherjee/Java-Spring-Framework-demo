...
public class EvenController {
	...
	//This annotation allows Spring to resolve and inject collaborating beans
	@Autowired
	...
	public EventModel postEvent(@RequestBody EventModel eventmodel) {
		...
		//seperating list of solution from the eventmodel
		...
		}//bidirectional mapping to solution is done.
